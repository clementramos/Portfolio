        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <form
            ...
            <input
              ...
              name="enterprise"
              required
              placeholder="A cool place to work in ;)"
              value={enterprise}
            ...
            <input
              ...
              name="email"
              required
              placeholder="I'm sure that's the best place to enter your email !"
              value={email}
            ...
            <textarea
              ...
              name="message"
              required
              placeholder="I'm sure i'll fall in love with that text <3"
              value={message}
